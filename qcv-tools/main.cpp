...
#include <multi/qrcode/QRCodeMultiReader.h>
#include <multi/ByQuadrantReader.h>
#include <multi/MultipleBarcodeReader.h>
#include <multi/GenericMultipleBarcodeReader.h>
#endif

using namespace std;
using namespace qcv;
//using namespace qcv::multi;
//using namespace qcv::qrcode;
