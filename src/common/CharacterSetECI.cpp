...
#include <common/CharacterSetECI.h>
#include <exception/IllegalArgumentException.h>
#include <exception/FormatException.h>

using std::string;

using qcv::common::CharacterSetECI;
using qcv::IllegalArgumentException;

std::map<int, qcv::Ref<CharacterSetECI> > CharacterSetECI::VALUE_TO_ECI;
std::map<std::string, qcv::Ref<CharacterSetECI> > CharacterSetECI::NAME_TO_ECI;
...
CharacterSetECI::CharacterSetECI(int const* values,
  ...
  qcv::Ref<CharacterSetECI> this_ref(this);
